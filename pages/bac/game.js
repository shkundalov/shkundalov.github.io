...
Что бы начать игру выберите желаемое колличество цифр и нажмите "Начать".
Цифры могут быть выставлены мышкой и клавиатурой (стрелки, пробел и Enter)`
    },
    Ura: {
        'language':'Ура',
        'specifyNumber': 'Длина шифра',
        'duplicate': 'Шпион',
        'guess': 'Подбор',
        'wrongPos': 'Свой',
        'correct': 'Офицер',
        ...
        'rulesH': 'Свод',
        'restart': 'За Родину!',
        'congrats': 'Ура Ура Ура!',
        'moves': 'Манёвры',
        'selDific': 'Поправка на простоту',
        'selectDigit': 'Определить своего',
        'easy': 'Ясли',
        'medium': 'Школа',
        'hard': 'Норма',
        'bul':'Свой',
        ...
        'number':'Шифровка',
        'gameCode':'Телеграмма',
        'rulesB': `Выведай шафр телеграммы.
Свой подскажет правильную цифру, а допрос шпиона только подскажет, что она из цифр верная.

Для встепления в бой необходимо определить сложность шифра и приступить к Бою.
Для выставления цифр используйте дергалку или тыкалку (стрелки, длинняшка и Кривулька)`
    }
}
var LG = Trans[LAN];
